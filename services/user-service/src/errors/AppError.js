...
class RateLimitError extends AppError {
  constructor(message) { super(message, 429, 'RATE_LIMIT_EXCEEDED'); }
}
class AIProviderError extends AppError {
  constructor(message) { super(message, 502, 'AI_PROVIDER_ERROR'); }
}
class DatabaseError extends AppError {
  constructor(message) { super(message, 503, 'DATABASE_ERROR'); }
}
